    ...
    return (
        <div className="flex-1 overflow-y-auto p-5 select-none">
            <div className="w-full flex flex-col gap-5">
                ...
                {/* 3x1 Grid: Left = Members List (2 cols), Right = Invitations Options (1 col) */}
                <div className={`grid grid-cols-1 ${canManageRoles ? "lg:grid-cols-3" : "grid-cols-1"} gap-6 items-start`}>
                    {/* Left Column: Project Members & Roles (takes 2 cols if canManageRoles) */}
                    <div className={`${canManageRoles ? "lg:col-span-2" : "col-span-1"} relative bg-[var(--app-card)] border border-[var(--app-border)] corner-brackets rounded-[2px] overflow-hidden flex flex-col min-w-0 shadow-2xs`}>
                        {/* Unified Card Header */}
                        <div className="px-4 py-3 border-b border-[var(--app-border)] bg-[var(--app-bg)]/40 flex items-center justify-between gap-3 min-h-[57px]">
                            <div className="min-w-0">
                                <h2 className="text-[13px] font-semibold text-[var(--app-text)] flex items-center gap-1.5">
                                    <span className="text-[11px] text-[var(--app-muted)]">▪</span>
                                    <span>Project Members & Roles</span>
                                </h2>
                                <p className="text-[11px] text-[var(--app-muted)] mt-0.5 truncate">
                                    {project.members?.length || 0} member{project.members?.length === 1 ? "" : "s"} collaborating on {project.title}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-[11px] border-collapse">
                                <thead>
                                    <tr className="border-b border-[var(--app-border)] text-[9px] font-medium text-[var(--app-muted)] capitalize bg-[var(--app-bg)]/60">
                                        <th className="pb-2 pt-2.5 px-4 min-w-[200px]">Member</th>
                                        <th className="pb-2 pt-2.5 px-3 w-[130px]">Role</th>
                                        <th className="pb-2 pt-2.5 px-3 w-[90px] text-center">Active Tasks</th>
                                        <th className="pb-2 pt-2.5 px-3 w-[95px] text-center">Capacity</th>
                                        <th className="pb-2 pt-2.5 px-3 w-[110px] text-center">Daily Load</th>
                                        <th className="pb-2 pt-2.5 px-4 w-[100px] text-right">Actions</th>
                                    </tr>
                                </thead>
                                            ...
                                            >
                                                ...
                                                <td className="py-3 px-4">
                                                    <div className="flex items-center gap-2.5 min-w-0">
                                                        ...
                                                        <div className="min-w-0">
                                                            ...
                                                            <span className="text-[9px] text-[var(--app-muted)] truncate block max-w-[220px]">
                                                                {member.user?.email || ""}
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <td className="py-3 px-3">
                                                    {canEditThisRowRole ? (
                                                        ...
                                                        <span className={`text-[9px] font-medium px-2 py-0.5 rounded-[2px] border inline-block ${role.cls}`}>
                                                            {role.label}
                                                        </span>
                                                    )}
                                                ...
                                                {/* Active Tasks Count */}
                                                <td className="py-3 px-3 text-center tabular-nums font-medium text-[var(--app-text)]">
                                                    {activeTasks}
                                                </td>
                                                ...
                                                <td className="py-3 px-3 text-center">
                                                    <div className="flex items-center justify-center gap-2">
                                                        <div className="w-12 h-1.5 bg-[var(--app-bg)] border border-[var(--app-border)] rounded-[1px] overflow-hidden">
                                                            <div
                    ...
                    {/* Right Column: Invite Members & Collaborators (takes 1 col) */}
                    {canManageRoles && (
                        <div id="add-project-member-section" className="lg:col-span-1 relative bg-[var(--app-card)] border border-[var(--app-border)] corner-brackets rounded-[2px] overflow-hidden flex flex-col min-w-0 shadow-2xs">
                            {/* Unified Card Header (1. Section Title & 2. Description) */}
                            <div className="px-4 py-3 border-b border-[var(--app-border)] bg-[var(--app-bg)]/40 min-h-[57px] flex flex-col justify-center">
                                <h2 className="text-[13px] font-semibold text-[var(--app-text)] flex items-center gap-1.5">
                                    <span className="text-[11px] text-[var(--app-muted)]">▪</span>
                                    <span>Invite Members & Collaborators</span>
                                </h2>
                                <p className="text-[11px] text-[var(--app-muted)] mt-0.5 leading-snug">
                                    Send project invitations to workspace teammates, cross-team colleagues, or by email.
                                </p>
                            </div>
                            ...
                            <div className="p-4 flex flex-col gap-3.5">
                                ...
                                <div className="grid grid-cols-3 gap-1 bg-[var(--app-bg)] border border-[var(--app-border)] p-0.5 rounded-[3px] text-[10px] font-medium">
                                    <button
                                        type="button"
                                        onClick={() => {
                                        ...
                                        className={`py-1.5 px-1 rounded-[2px] transition-all cursor-pointer flex items-center justify-center gap-1 text-center truncate ${
                                            addMode === "workspace"
                                                ? "bg-[var(--app-card)] text-[var(--app-text)] shadow-xs font-semibold border border-[var(--app-border)]"
                                    ...
                                    >
                                        ...
                                        <span className="text-[9px] text-[var(--app-muted)] tabular-nums">
                                    ...
                                    <button
                                        ...
                                        title="All Teams / Platform Directory"
                                    >
                                    ...
                                    >
                                        ...
                                        <span className="truncate">By Email</span>
                                    </button>
                                </div>
                                        ...
                                        {availableWorkspaceMembers.length > 0 ? (
                                            <>
                                                ...
                                                <button
                                                    ...
                                                    className="relative corner-brackets-4 bg-[var(--app-card)] hover:bg-[var(--app-hover-bg)] border border-[var(--app-border)] hover:border-[var(--app-border-strong)] text-[var(--app-text)] font-medium text-[11px] px-3.5 py-1.5 rounded-[2px] transition-all h-[32px] flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed shadow-2xs mt-1"
                                                >
                                                    {isAddingMember ? (
                                                ...
                                                <div className="flex flex-col gap-1.5 pt-2 border-t border-[var(--app-border)]/60">
                                                    <span className="text-[9px] text-[var(--app-muted)]">Quick Select:</span>
                                                    <div className="flex flex-wrap items-center gap-1">
                                                        {availableWorkspaceMembers.slice(0, 6).map((tm) => (
                                                            <button
                                                                ...
                                                                className={`px-2 py-0.5 text-[10px] border rounded-[2px] transition-colors cursor-pointer flex items-center gap-1 ${
                                                                    newMemberId === tm.user.id
                                                                        ? "bg-[var(--app-text)] text-[var(--app-card)] border-[var(--app-text)] font-semibold"
                                                                        : "bg-[var(--app-bg)] hover:bg-[var(--app-hover-bg)] text-[var(--app-text)] border-[var(--app-border)]"
                                                                }`}
                                                            >
                                                                <UserAvatar
                                                                    ...
                                                                    size="xs"
                                                                />
                                                                <span className="truncate max-w-[80px]">{tm.user.name}</span>
                                                            </button>
                                                        ))}
                                                    </div>
                                                </div>
                                            ...
                                            <div className="flex flex-col items-center justify-center text-center p-4 bg-[var(--app-bg)]/40 border border-dashed border-[var(--app-border)] rounded-[2px] gap-2 my-1">
                                                <Users className="w-5 h-5 text-[var(--app-muted)] opacity-60" />
                                                <div>
                                                    <p className="text-[11px] font-medium text-[var(--app-text)]">
                                                        All team members joined
                                                    </p>
                                                    <p className="text-[10px] text-[var(--app-muted)] mt-0.5 max-w-[240px]">
                                                        Everyone on this workspace team is already in this project.
                                                    </p>
                                                </div>
                                                <button
                                                    type="button"
                                                    onClick={() => setAddMode("all")}
                                                    className="mt-1 text-[10px] text-[var(--app-text)] hover:underline flex items-center gap-1 font-medium cursor-pointer"
                                                >
                                                    <span>Explore All Teams directory</span>
                                                    <span>→</span>
                                                </button>
                                            </div>
                                        )}
                                ...
                                {addMode === "all" && (
                                    <div className="flex flex-col gap-3 pt-0.5">
                                        <p className="text-[11px] text-[var(--app-muted)] leading-relaxed">
                                            Search for any colleague across the organization or other teams to invite them as a collaborator.
                                        </p>
                                ...
                                {addMode === "email" && (
                                    <form
                                        ...
                                        className="flex flex-col gap-3 pt-0.5"
                                    >
                                        <p className="text-[11px] text-[var(--app-muted)] leading-relaxed">
                                            Enter the email address of any registered user to invite them to this project.
                                        </p>
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-[var(--app-bg)] border border-[var(--app-border)] rounded-[2px] px-2.5 py-1.5 text-[11px] text-[var(--app-text)] focus:outline-none focus:border-[var(--app-border-strong)]"
                                                required
                                            />
                                        </div>
