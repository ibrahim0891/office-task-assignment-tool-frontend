    ...
    if (!isAllowed) {
        return (
            <div className="w-full h-full flex flex-col justify-center items-center p-6 bg-[var(--app-bg)] text-center select-none font-sans">
                <div className="bg-[var(--app-card)] border border-[var(--app-border)] p-8 sm:p-10 rounded-[3px] max-w-md flex flex-col items-center gap-4.5 shadow-md corner-brackets">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <p className="text-xs text-[var(--app-muted)] leading-relaxed">
                            The Solar Map is exclusive to Workspace Leaders and
                            Observers. Standard members do not have permission
                            to view this relational workspace visualization.
                        </p>
                    </div>

                    <Button
                        type="button"
                        onClick={() => router.replace("/task-board")}
                        showDot
